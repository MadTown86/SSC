...
class TestSimpTableFuncs(unittest.TestCase):
    ...
    def test_create_commit(self, mock_connector):
        ...
        correctcallconnect = unittest.mock.call(
            database="sscdb",
            host="localhost",
        ...
        mock_execute = (
            mock_connector.connect.return_value.__enter__.return_value.cursor.return_value.__enter__.return_value.execute.call_args
        )
