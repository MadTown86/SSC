...
class TestParseMock_Sub(unittest.TestCase):
    ...
    def test_parsebalance_tickefailflag(self, Mock_FetchShelfSSC, Mock_FetchSSC):
        ...
        hpr.testmock_print(TestParseMock_Sub.DoubleD_TheDilenschnazzle, "DOUBLE DEEEEEE")

        print(test_fetchnamepassin)
        Mock_FetchSSC.return_value.ticker_fail.assert_called_with(fetchname='TEST__TEST__TEST__TEST')
