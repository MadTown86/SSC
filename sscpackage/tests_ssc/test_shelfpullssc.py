...
class MyTestCase(unittest.TestCase):
    def test_shelfpullssc(self):
        pathtoshelve = ROOT_VAR_SSC + "testshelvessc"

        first_resssc = {
            "First Key": {"FK1": "FV1", "FK2": "FV2"},
            "Second Key": {"FK22": "FV22", "FK23": "FV23"},
        }
        ...
        self.assertEqual(
            SV.pullvalueinshelfssc(pathtoshelve, keyfortestssc), third_resssc
        )
