...
class MyTestCase(unittest.TestCase):
    ...
    def test_testnest(self):
        self.assertEqual(
            testnest_answer, self.dictp.dictpullssc(testnest, testnest_request)
        )

    def test_simpletest(self):
        self.assertEqual(
            simpletest_answer, self.dictp.dictpullssc(simpletest, simpletest_request)
        )

    def test_testdict(self):
        self.assertEqual(
            testdict_answer, self.dictp.dictpullssc(testdict, testdict_request)
        )

    def test_complexdict(self):
        self.assertEqual(
            complexdict_answer, self.dictp.dictpullssc(complexdict, complexdict_request)
        )
